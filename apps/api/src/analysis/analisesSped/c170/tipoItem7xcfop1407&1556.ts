...
export const TipoItem7Cfop1407e1556 = {
  ...
  description:
    "Uso e Consumo - Tipo Item = 07 x CFOP diferente de 1.407 ou 1.556",
  groupName: "C170",
  fields: [
      ...
      for (const item of nota.itens) {
        ...
        if (
          ...
          erros.push({
            ...
            descrItem: cad?.DESCR_ITEM ?? "Descrição não encontrada",
            cfop: item.CFOP,
            tipoItem: cad?.TIPO_ITEM ?? "Tipo Item não encontrado",
