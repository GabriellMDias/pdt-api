...
import BackupGoogleDrivePage from "../pages/configuracoes/acoes-agendadas/backup-google-drive/BackupGoogleDrivePage";
...
import CurvaAbcPage from "../pages/administrativo/curva-abc/CurvaAbcPage";
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Curva ABC",
        icon: <BackupTableIcon />,
        element: <CurvaAbcPage />,
        showInSidebar: true,
        requiredPermissions: ["curva-abc:consultar"],
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        requiredPermissions: [
          "top-restrictions:consultar",
          "top-restrictions:editar",
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/configuracoes/cadastro/lojas",
            label: "Lojas",
            icon: <StorefrontIcon />,
            element: <StoresPage />,
            showInSidebar: true,
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "/configuracoes/acoesagendadas/backup-google-drive",
            label: "Backup Google Drive",
            showInSidebar: true,
            icon: <BackupTableIcon />,
            element: <BackupGoogleDrivePage />,
            requiredPermissions: ["dbScripts:consultar"],
          },
          {
