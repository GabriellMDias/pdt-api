...
export class CostCentersService {
  ...
  async getCostCenterFromSankhya() { 
    ...
    for(const newCostCenterType of newCostCenterTypes){
      ...
      await this.notifyCostCenterTypeCreated(newId, newCostCenterType.DESCRCENCUS);
  ...
  async createCostCenterType(createCostCenterTypeDto: CreateCostCenterTypeDto) {
    ...
    await this.notifyCostCenterTypeCreated(result.id, data.description);
  ...
  private async notifyCostCenterTypeCreated(costCenterTypeId: number, costCenterTypeDesc: string) {
    ...
    await this.notificationsService.notifyCostCenterTypeCreated(costCenterTypeId, costCenterTypeDesc, userIds);
  }
}
